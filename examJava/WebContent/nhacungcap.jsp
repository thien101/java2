		    ...
		    <div style="height: 100px; width: 1200px; position: absolute; bottom: 0px; padding-top: 20px;">
		    	<center>
		    		...
		    		<div style="padding-top: 12px">
		    			<input type="submit" value="Thêm" name="them" style="padding: 2px 20px;">
			    		<input type="submit" value="Sửa" name="sua" style="padding: 2px 20px; margin: 0px 50px;">
			    		<input type="submit" value="Xóa" name="xoa" style="padding: 2px 20px; margin-right: 10px;">
		    		</div>
		    	</form>
		    	</center>
		    </div>
