	...
	<div style="width: 1300px; margin: 0px 25px; padding: 20px 0px; min-height: 525px;">
		<table style="width: 1300px;text-align: center;">
				<tr>
					...
					<td style="border: 1px solid; width: 250px">Tên Khách Hàng</td>
					<td style="border: 1px solid; width: 250px">Thành Tiền</td>
					<td style="border: 1px solid; width: 225px">Ngày Đặt</td>
					<td style="border: 1px solid; width: 200px">Đã Duyệt</td>
					<td style="border: 1px solid; width: 225px">Ngày Duyệt</td>
				</tr>
				<%
				...
				<tr>
					...
					<td style="border: 1px solid; width: 250px"><%=(hd.isDuyet() == true)?"Đã được duyệt" : "Chưa được duyệt" %></td>
					<td style="border: 1px solid; width: 200px"><%=(hd.getNgayduyet() == null)?"Đang chờ":hd.getNgayduyet() %></td>
				</tr>
				<%} %>
			</table>
	</div>
